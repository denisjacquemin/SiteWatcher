...
var ross = (function($) {
	...
	if(data.mode == "unauthenticated") $('#tool-right').wrapInner('<div id="ident"><a href="javascript:openConnect()" class="connected colorbox">Je me connecte</a><ul><li><a href="http://pdf.lesoir.be/mon_profil/register.php?aff=FULL&backurlPDF='+encodeURIComponent(window.location.href)+'">Je m\'inscris</a></li></ul></div><div id="encart-newsletter"></div><div id="une-abo"><a href="http://pdf.lesoir.be/"><img height="143" width="102" src="http://www.lesoir.be/modules/pdf/cache/2front_full.jpg" alt="Aperçu de la une"></a></div>'  + data.iframe);
